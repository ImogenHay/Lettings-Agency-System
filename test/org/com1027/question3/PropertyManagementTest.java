...
public class PropertyManagementTest {
	...
	public void testDisplayAllCouncilTaxExemptProperties() {
		...
		Tenant Student1 = new Tenant("Alice", "Wonderland", 18, TenantType.STUDENT);
		Tenant Student2 = new Tenant("Bob", "Ross", 53, TenantType.STUDENT);
		Tenant Prof1 = new Tenant("Alice", "Wonderland", 18, TenantType.PROFESSIONAL);
		Tenant Prof2 = new Tenant("Bob", "Ross", 53, TenantType.PROFESSIONAL);

		Property houseS = new House(10, "The Chase", "Guildford", "GU2 7UB", 2);
		Property houseP = new Flat(20, "The Madrid Road", "Guildford", "GU2 7UB", 2, 3);

		pm.addProperty(houseS);
		pm.addProperty(houseP);

		pm.addTenant(houseS, room1, Student1);
		pm.addTenant(houseS, room2, Student2);
		pm.addTenant(houseP, room1, Prof1);
		pm.addTenant(houseP, room2, Prof2);

		houseS.setCouncilTax(1000);
		houseP.setCouncilTax(1500);
		...
		assertThat(pm.displayAllCouncilTaxExemptProperties(), anyOf(is(output1), is(output2)));
	}
